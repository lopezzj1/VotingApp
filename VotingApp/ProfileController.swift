...
class ProfileController: UIViewController, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let nav = self.navigationController as! HackyNavController
        firstNameTextField.text = nav.cachedUser?["firstName"] as! String
        lastNameTextField.text = nav.cachedUser?["lastName"] as! String
        emailTextField.text = nav.cachedUser?["email"] as! String
        addressTextField.text = nav.cachedUser?["address"] as! String
        cityTextField.text = nav.cachedUser?["city"] as! String
        stateTextField.text = nav.cachedUser?["state"] as! String
        zipcodeTextField.text = nav.cachedUser?["zipcode"] as! String
        
        
        
        
        let pickerIdx = states.indexOf(nav.cachedUser?["state"] as! String)
        self.picker.selectRow(pickerIdx!, inComponent: 0, animated: false)
    ...
    @IBAction func submitButtonPressed(sender: AnyObject) {
        ...
        if (firstNameTextField.text != "" || lastNameTextField.text != "" || addressTextField.text != "" || cityTextField.text != "" || zipcodeTextField.text != "" || stateTextField.text != "") {
    ...
    func textFieldShouldReturn(textField: UITextField) -> Bool {
        let signUpOrder = [firstNameTextField, lastNameTextField, passwordTextField, confirmPasswordTextField, addressTextField, cityTextField, stateTextField, zipcodeTextField]
